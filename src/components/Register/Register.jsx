...
export default function Register() {
      ...
      <div className='bgRegister'>
       <div className='RegisterElement md:w-[900px] bg-[#122926] mx-auto my-[50px] px-[50px]'>
        <div className='inner md:w-[900px] border border-[#5a5959]'>
          ...
          <p className='text-[#F2DA16] font-bold'>UserID: <span className='text-[#8CC43F]'>RHI218277</span></p>
  ...
  <div className='mt-[30px]'><input type='checkbox' checked/></div><span className='relative left-[20px] bottom-6'>I agree to the<span className='text-[#8CC43F]'> Terms Conditions</span></span>
  <div className='py-[5px] text-center'>
  <button className='bg-[#8CC43F] p-2 text-center w-[200px] font-bold rounded'>Register</button>
  </div>
  <p className='float-right'>Already Have an account? <a href='/login' className='text-[#8CC43F]'>Log in</a></p>
  </div>
  </section>  
